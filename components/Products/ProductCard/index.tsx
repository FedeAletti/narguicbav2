	...
	return (
		<>
			<motion.div
				...
				className={`flex-shrink-0 h-full w-full m-6 relative overflow-hidden bg-[#581c87] rounded-lg max-w-md mx-auto shadow-lg group transition-all ease-linear duration-200 hover:cursor-pointer`}>
				<div>
